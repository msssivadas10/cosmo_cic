...
from models2.cosmology import Cosmology
...
# z, y1, y2, y3, y4 = np.loadtxt('test/z_out.csv', skiprows = 1, delimiter = ',', unpack = 1)
...
k, y1, y2, y3, y4, y5, y6 = np.loadtxt('test/power.csv', skiprows = 1, delimiter = ',', unpack = 1)

# x1 = cm.matterTransferFunction(k/cm.h, 0.)
# plt.loglog(k, x1, '-o', ms = 10)
# plt.loglog(k, y1, 'o')

# x2 = cm.matterPowerSpectrum(k/cm.h, 0., normalize=0) / cm.h**3
...
# x4 = cm.matterVariance(k*cm.h, 0., normalize=0)
